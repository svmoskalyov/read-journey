  ...
  return (
    <ChakraSelect.Control {...rest}>
      ...
      <ChakraSelect.IndicatorGroup>
        ...
        <ChakraSelect.Indicator color="brand.accent" />
      </ChakraSelect.IndicatorGroup>
...
export const SelectItem = React.forwardRef(function SelectItem(props, ref) {
  ...
  return (
    ...
    >
      {children}
      <ChakraSelect.ItemIndicator color="brand.accent" />
    </ChakraSelect.Item>
  )
})
...
export const SelectItemGroup = React.forwardRef(function SelectItemGroup(
  props,
  ref
) {
